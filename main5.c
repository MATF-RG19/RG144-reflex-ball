...
static int mistake;
static int levelup;
static int timer_mistake_active;
...
static void on_display(void){
	...
	glEnd();*/
	if(mistake){
		GLfloat ambient_coeffsm[] = { 1, 0, 0, 1 };
		GLfloat diffuse_coeffsm[] = { 1, 0, 0, 1 };
		
		glMaterialfv(GL_FRONT, GL_AMBIENT, ambient_coeffsm);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, diffuse_coeffsm);
	}
	else if(levelup){
		GLfloat ambient_coeffsl[] = { 0, 1, 0, 1 };
		GLfloat diffuse_coeffsl[] = { 0, 1, 0, 1 };
		
		glMaterialfv(GL_FRONT, GL_AMBIENT, ambient_coeffsl);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, diffuse_coeffsl);
	}
	else{
		GLfloat ambient_coeffs0[] = { 0, 0.9, 1, 1 };
		GLfloat diffuse_coeffs0[] = { 0, 0.9, 1, 1 };
	...
	GLfloat ambient_coeffs2[] = { 1.0, 1.0, 0.0, 1 };
    GLfloat diffuse_coeffs2[] = { 1.0, 1.0, 0.0, 1 };
	...
	GLfloat ambient_coeffs3[] = { 0.0, 1, 0.0, 1 };
    GLfloat diffuse_coeffs3[] = { 0.0, 1, 0.0, 1 };
    ...
    GLfloat ambient_coeffs4[] = { 0.12, 0.0, 0.0, 1 };
    GLfloat diffuse_coeffs4[] = { 0.12, 0.0, 0.0, 1 };
    
    glMaterialfv(GL_FRONT, GL_AMBIENT, ambient_coeffs4);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, diffuse_coeffs4);
